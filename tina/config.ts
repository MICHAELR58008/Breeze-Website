            ...
            templates: [
              {
                ...
                fields: [
                  ...
                  { type: "number", name: "headingLine1X", label: "Heading 1 — X Offset" },
                  { type: "number", name: "headingLine1Y", label: "Heading 1 — Y Offset" },
                  { type: "string", name: "headingLine2" },
                  { type: "number", name: "headingLine2X", label: "Heading 2 — X Offset" },
                  { type: "number", name: "headingLine2Y", label: "Heading 2 — Y Offset" },
                  { type: "string", name: "subheading" },
                  { type: "number", name: "subheadingX", label: "Subheading — X Offset" },
                  { type: "number", name: "subheadingY", label: "Subheading — Y Offset" },
              ...
              },
              {
                ...
                fields: [
                  ...
                  { type: "number", name: "eyebrowSize", label: "Eyebrow Font Size (px)" },
                  { type: "string", name: "eyebrowColor", label: "Eyebrow Color", ui: { component: "color" } },
                  { type: "number", name: "headingSize", label: "Heading Font Size (px)" },
                  { type: "string", name: "headingColor", label: "Heading Color", ui: { component: "color" } },
                  { type: "number", name: "bodySize", label: "Body Font Size (px)" },
                  { type: "string", name: "bodyColor", label: "Body Color", ui: { component: "color" } },
                ],
              },
              {
                name: "about",
                ...
                fields: [
                  ...
                  { type: "number", name: "eyebrowSize", label: "Eyebrow Font Size (px)" },
                  { type: "string", name: "eyebrowColor", label: "Eyebrow Color", ui: { component: "color" } },
                  { type: "number", name: "headingSize", label: "Name Font Size (px)" },
                  { type: "string", name: "headingColor", label: "Name Color", ui: { component: "color" } },
                  { type: "number", name: "bodySize", label: "Bio Font Size (px)" },
                  { type: "string", name: "bodyColor", label: "Bio Color", ui: { component: "color" } },
                ],
              },
              {
                name: "testimonials",
              ...
              },
              {
                ...
                fields: [
                  { type: "string", name: "tagline" },
                  { type: "number", name: "bodySize", label: "Text Font Size (px)" },
                  { type: "string", name: "bodyColor", label: "Text Color", ui: { component: "color" } },
                ],
              },
            ],
          },
